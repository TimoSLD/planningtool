...
<body class="bg-dark">
    ...
    <div class="container img-thumbnail mt-3">
        <div class="row">
            <img class="mt-2 col-0 p-3 gameimg img-thumbnail w-25" src="img/<?= $result['image']?>">
            <div class="mt-2 pt-3 col img-thumbnail"> <?= $result['description']?><hr>
            ...
            <div class=""><a>play minutes: </a><?= $result['play_minutes']?></div></div><hr>
        </div>
        <div class="img-thumbnail">
            <div class=""><?= $result['youtube']?></div>
            <a class="" href='<?= $result['url']?>'></i>kopen...</a>
        </div>
    </div>
